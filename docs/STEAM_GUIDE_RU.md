...
Если мод был установлен до v0.1.25 или кнопка `AUTO` не появляется, полностью закройте Steam и один раз повторите установку из актуального ZIP: установщик восстановит постоянный параметр запуска. Сохранения и файлы игры не затрагиваются.
